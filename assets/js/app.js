(function() {
    ...
    var e = {
        82 : function(e, n, t) {
            ...
            const p = [{
                path: "/",
                name: "Home",
                component: () = >t.e(344).then(t.bind(t, 5344))
            }],
            v = (0, d.p7)({
                history: (0, d.r5)(),
                routes: p
            ...
            b = t(137);
            const y = (0, r.ri)(l);
            for (const w in b) y.component(w, b[w]);
            y.use(g).use(h).use(o.Z, {
                size: "small"
            }).use(i.Z).mount("#app")
        }
    },
        ...
        t.O = function(n, r, o, i) {
            if (!r) {
                ...
                for (s = 0; s < e.length; s++) {
                    ...
                    i = e[s][2];
                    for (var a = !0,
                    c = 0; c < r.length; c++)(!1 & i || u >= i) && Object.keys(t.O).every((function(e) {
                        return t.O[e](r[c])
    ...
    function() {
        ...
        t.l = function(r, o, i, u) {
            if (e[r]) e[r].push(o);
                ...
                var a, c;
                if (void 0 !== i) for (var f = document.getElementsByTagName("script"), s = 0; s < f.length; s++) {
                    var l = f[s];
                ...
                a || (c = !0, a = document.createElement("script"), a.charset = "utf-8", a.timeout = 120, t.nc && a.setAttribute("nonce", t.nc), a.setAttribute("data-webpack", n + i), a.src = r),
                e[r] = [o];
                var d = function(n, t) {
    ...
    function() {
        ...
        var n = function(n, r) {
            ...
            for (n && n(r); f < u.length; f++) i = u[f],
            t.o(e, i) && e[i] && e[i][0](),
            e[i] = 0;
            return t.O(s)
        },
        r = self["webpackChunkvueclash"] = self["webpackChunkvueclash"] || [];
